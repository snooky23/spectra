...
private val CONSOLE_BRIDGE_JS_SOURCE =
    """
    (function() {
...
const val SPECTRA_WEBVIEW_HANDLER_NAME = "spectra"

/**
 * Creates a WKUserScript configured to inject the Spectra console bridge.
 */
fun createSpectraBridgeScript(): WKUserScript =
    WKUserScript(
        source = CONSOLE_BRIDGE_JS_SOURCE,
...
fun WKWebViewConfiguration.attachSpectraLogger(
    ...
    userContentController.addScriptMessageHandler(handler, name = SPECTRA_WEBVIEW_HANDLER_NAME)
    userContentController.addUserScript(createSpectraBridgeScript())
}
