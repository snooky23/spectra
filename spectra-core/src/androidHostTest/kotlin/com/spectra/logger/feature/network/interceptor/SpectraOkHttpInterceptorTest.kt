...
class SpectraOkHttpInterceptorTest {
    ...
    @Test
    fun `test successful 200 OK request logs correctly`() =
    ...
    @Test
    fun `test 201 Created request logs correctly`() =
        runTest(UnconfinedTestDispatcher()) {
            SpectraLogger.setCoroutineScopeForTesting(this)
            SpectraLogger.clearNetwork()
    ...
    @Test
    fun `test 400 Bad Request logs correctly`() =
        runTest(UnconfinedTestDispatcher()) {
            SpectraLogger.setCoroutineScopeForTesting(this)
            SpectraLogger.clearNetwork()
    ...
    @Test
    fun `test 404 Not Found logs correctly`() =
        runTest(UnconfinedTestDispatcher()) {
            SpectraLogger.setCoroutineScopeForTesting(this)
            SpectraLogger.clearNetwork()
    ...
    @Test
    fun `test 500 Server Error request logs correctly`() =
        runTest(UnconfinedTestDispatcher()) {
            SpectraLogger.setCoroutineScopeForTesting(this)
            SpectraLogger.clearNetwork()
    ...
    @Test
    fun `test network exception is logged correctly`() =
        runTest(UnconfinedTestDispatcher()) {
            SpectraLogger.setCoroutineScopeForTesting(this)
            SpectraLogger.clearNetwork()
    ...
    @Test
    fun `test plugin overhead is under 15ms`() =
        runTest(UnconfinedTestDispatcher()) {
            SpectraLogger.setCoroutineScopeForTesting(this)
            SpectraLogger.clearNetwork()
    ...
    @Test
    fun `test ignore list successfully drops traffic without logging`() =
        runTest(UnconfinedTestDispatcher()) {
            SpectraLogger.setCoroutineScopeForTesting(this)
            SpectraLogger.clearNetwork()
