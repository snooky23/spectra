...
class NetworkFilterEngineRepositoryTest {
    ...
    @Test
    fun testNetworkStatisticsAggregation() = runTest {
        val storage = InMemoryNetworkLogStorage()
        val repository = NetworkFilterEngineRepositoryImpl(storage)
        ...
        repository.statistics.test {
            ...
            assertEquals(0, initialState.totalRequests)

            // Processed initial logs
            val stats = awaitItem()
